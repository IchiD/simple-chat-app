<template>
  <div class="max-w-6xl mx-auto p-4">
    <!-- テスト環境バナー -->
    <div
      v-if="isStripeTestMode"
      class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded-lg mb-4"
    >
          ...
          >
            <div class="flex items-start">
              ...
              <div class="text-xs text-yellow-800">
                ...
                <ul class="space-y-1">
                  <li>• 料金は月額制で、毎月の請求日に自動的に請求されます</li>
                  <li>• プラン変更は即座に反映され、日割り計算されます</li>
                  <li>
                    •
                    解約はいつでも可能で、契約期間終了まではサービスをご利用いただけます
                  </li>
                  <li>
                    •
                    既にお支払いいただいた期間分のサービスは最後までご利用可能です
                  </li>
                  <li>
...
const faqs = ref([
  {
    ...
    answer:
      "はい、いつでもプランの変更・解約が可能です。変更は即座に反映され、機能も使用可能となります。解約の場合は、契約期間終了まで現在のプランをご利用いただけます。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "無料トライアルご希望の方はページ下部のお問い合わせよりご連絡いただけますと幸いです。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "解約後も、既にお支払いいただいた契約期間が終了するまでは、現在のプランの全機能をご利用いただけます。契約期間終了後に自動的に無料プランに移行いたします。月額制のため、使用した期間分のサービスを提供いたします。",
  },
  {
    question: "解約した場合、作成したグループはどうなりますか？",
    answer: "自分がオーナーであるグループは削除されます。",
  },
]);
