    ...
    <div v-else class="min-h-screen bg-gray-50 p-4">
      <div class="max-w-5xl mx-auto">
        ...
        <div v-else-if="group" class="space-y-8">
          ...
          <!-- グループ削除セクション -->
          <div
            class="bg-white rounded-lg shadow-sm border border-red-200 p-6 mt-8"
          >
            <h2
              class="text-lg font-semibold text-red-900 mb-4 flex items-center"
            >
              <svg
            ...
            <button
              class="px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg transition-colors duration-200 flex items-center"
              :disabled="deleting"
      ...
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div class="p-6">
          ...
          <div class="flex justify-end space-x-3">
            ...
            <button
              class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700 transition-colors disabled:opacity-50"
              :disabled="deleting"
              @click="deleteGroup"
            >
...
const deleteGroup = async () => {
  ...
  deleting.value = true;
  try {
    await groupConversations.deleteGroup(group.value.id);
